...
const requests = {
  ...
  fetchAnimation: `discover/movie?api_key=${API_KEY}&with_watch_providers=213&with_genres=16`,
  fetchAdventure: `discover/movie?api_key=${API_KEY}&with_watch_providers=213&with_genres=12`,
  fetchSciFi: `discover/movie?api_key=${API_KEY}&with_watch_providers=213&with_genres=878`,
};
